...
var sx,sy;
  ...
  $.fn.wPaint.extend({
    ...
    _drawTextDown: function (e) {
      ...
      this.$textInput
      .css({left: e.pageX - 1, top: e.pageY - 1, width: 0, height: 0,color:'black'})
      .show().focus();
    ...
    _drawText: function () {
      ...
      this.lines = this.$textInput.val(linesNew.join('')).val();
      ...
      this.$textInput.css('color','black');
      this.$textInput.val('');
      this._addUndo();
    }
  });
