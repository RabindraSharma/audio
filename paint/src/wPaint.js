(function ($) {
  ...
  Paint.prototype = {
    ...
    _drawShapeMove: function (e, factor) {
      ...
      //console.log('move '+e.w+' '+e.h+' '+e.width+' '+e.height)
    ...
    _drawShapeUp: function (e) {
        // if($(this.canvasTemp).attr('width')!=0 && $(this.canvasTemp).attr('height')!=0){
        //     this.ctx.drawImage(this.canvasTemp, this.canvasTempLeftNew, this.canvasTempTopNew);
        //     this.$canvasTemp.show();
        //     this.canvasWidth = moveX;
        //     this.canvasHeight = moveY;
